    ...
    <>
      {emi > 0 && (
        <div className="px-1 py-3">
          <h3 className="bg-gray-50 dark:bg-gray-800 text-lg font-bold py-2 my-2 px-3 border rounded border-gray-200 dark:border-gray-700 dark:text-gray-400">EMI: ₹{emi.toFixed(2)}</h3>
